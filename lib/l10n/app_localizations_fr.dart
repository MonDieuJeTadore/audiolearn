...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String obtainingYoutubePlaylistVideosError(
    ...
    return 'ÉCHEC de l\'obtention de la liste des videos contenues dans la playlist Youtube \"$playlistTitle\": \"$exceptionMessage\".';
  }
  ...
  String commentUpdateDateTooltip(Object creationDateTime) {
    return 'Date et heure de mise à jour du commentaire $creationDateTime.';
  }
  ...
  String get isPlayableTooltip =>
      'L\'audio n\'est pas jouable si son mp3 n\'est pas disponible !';
  ...
  String noAudioMp3WereSavedToZip(Object audioDownloadFromDateTime) {
    return 'Aucun fichier audio MP3 n\'a été sauvegardé dans un fichier ZIP du fait qu\'aucun audio n\'a été téléchargé, importé ou extrait à partir du $audioDownloadFromDateTime.\n\nConcernant les audios convertis (texte en audio), aucun fichier audio MP3 n’a été sauvegardé dans le fichier ZIP, car aucun commentaire d’audio converti n’a été créé ou modifié à partir du $audioDownloadFromDateTime.';
  }
  ...
  String get obtainMostRecentAudioDownloadDateTimeMenu =>
      'Obtenir la date de téléchargement la plus récente des audios restaurés pour de multiple playlists ...';

  @override
  String get obtainMostRecentAudioDownloadDateTimeTooltip =>
      'Obtenez la date de téléchargement audio la plus récente parmi les derniers audios restaurés pour de multiple playlists. Utilisez cette date lors de la création de sauvegardes ZIP avec le menu \'Sauver les audios MP3 des playlists dans des fichiers ZIP ...\' pour ne capturer que les fichiers audio les plus récents afin de les restaurer dans cette version de l\'application.';

  @override
  String get displayLatestRestoredAudioDateTimeTitle =>
      'Date récente de téléchargement des audios restaurés';

  @override
  String displayLatestRestoredAudioDateTime(
      Object newestAudioDownloadDateTime) {
    return 'Ceci est la date/heure de téléchargement la plus récente des audios restaurés pour de multiple playlists: $newestAudioDownloadDateTime.';
  }
  ...
  String get convertingDownloadedAudioToMP3 =>
      'Conversion du MP4 ou WEBM en MP3 ...';
  ...
  @override
  String get editAudioTitle => 'Editer l\'audio';
  ...
  String get generateAndPlayAudioCommentTooltip =>
      'Générer et lire ce commentaire audio.';

  @override
  String get editAudioCommentTooltip =>
      'Modifier les valeurs du commentaire et les enregistrer. CELA PERMET ÉGALEMENT DE RÉINCLURE CE COMMENTAIRE EN L’ENREGISTRANT, AVEC OU SANS MODIFICATION.';
  ...
  String get modifyFilteredAudioLastListenedDateTime =>
      'Modifier la date de dernière écoute des audios filtrés ...';

  @override
  String get setAudioLastListenedDateTitle =>
      'Définir la date de dernière écoute';

  @override
  String get setAudioLastListenedDateTitleExplanation =>
      'La date définie sera appliquée à chaque audio filtré.';

  @override
  String get setAudioLastListenedDateTitleTooltip =>
      'Ceci est utile si les audios concernés n\'ont pas été écoutés avant la date définie.';

  @override
  String get lastListenedDate => 'Date dernière écoute';
  ...
  String get modifyAudioListenedDateMenu =>
      'Modifier la date de dernière écoute de l\'audio ...';

  @override
  String get modifyAudioListenedDate => 'Définir la date d\'écoute';

  @override
  String get listenedDateLabel => 'Date d\'écoute';

  @override
  String get modifyAudioListenedDateButton => 'Modifier';

  @override
  String get modifyAudioListenedDateTooltip =>
      'Indiquer la date d\'écoute qui sera définie dans l\'audio. Ceci va modifier le jour où l\'audio sera joué.';
